...
import { Class, JSONClass } from './Class';
import { Dimension, JSONDimension } from './Dimension';
...
export class Property {
    ...
    constructor(
        ...
        if (typeof name === 'object') {
            ...
            this.id = property.id !== undefined ? property.id : toID(this.name);
            ...
            this.entityId = property.entity_id !== undefined ? property.entity_id : null;
        } else {
