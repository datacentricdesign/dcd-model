    ...
    constructor(code: number, hint: string) {
        ...
        switch (code) {
            case 400:
                ...
                this.requirements = 'Something is missing or malformed in body, query params or path params.';
                break;
            case 4001:
                this.status = 400;
            ...
            case 4031:
                this.status = 403;
                this.message = 'Access denied - Authentication information missing, malformed or invalid';
