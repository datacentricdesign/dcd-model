...
// Test: create a Person
    ...
    .then((persons) => {
        assert.equal(persons.length, 1,
            'List of persons should have 1 element.');
    ...
    .then((result) => {
        assert.equal(result.valid, false,
            'Person check should return false');
    ...
    .then((things) => {
        assert.equal(things.length, 1,
            'List of things should have 1 element.');
    ...
    // Test: read property
    .then(() => {
        return model.properties.read(property.id);
    })
    ...
    .then((properties) => {
        assert.equal(properties.length, 1,
            'List of properties should have 1 element.');
